...
def main():
    ...
    atoms1_str = "resname CYX and resid 145 and name CA"
    atoms2_str = "resname CYX and resid 202 and name CA"
    ...
    atoms_npy_path = os.path.join(data_dir, "cyx145_ca-cyx202_ca-dist.npy")
