    ...
    for run_i in range(1, 4):
        trajectory_paths.extend(
            [
                os.path.join(
                    base_dir,
                    f"data/003-rogfp-cu-md/simulations/05-prod/run-0{run_i}/outputs/08_prod_npt.nc",
                ),
                os.path.join(
                    base_dir,
                    f"data/003-rogfp-cu-md/simulations/06-prod/run-0{run_i}/outputs/09_prod_npt.nc",
                ),
                os.path.join(
                    base_dir,
                    f"data/003-rogfp-cu-md/simulations/06-prod/run-0{run_i}/outputs/10_prod_npt.nc",
                ),
            ]
        )
