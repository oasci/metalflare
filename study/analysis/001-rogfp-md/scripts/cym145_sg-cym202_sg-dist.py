...
def main():
    ...
    atoms1_str = "resname CYM and resid 145 and name SG"
    atoms2_str = "resname CYM and resid 202 and name SG"
    ...
    atoms_npy_path = os.path.join(data_dir, "cym145_sg-cym202_sg-dist.npy")
