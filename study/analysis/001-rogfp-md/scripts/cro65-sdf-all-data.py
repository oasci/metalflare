...
def main():
    ...
    trajectory_path = os.path.join(
        base_dir, "analysis/001-rogfp-md/data/traj/aligned_cro.nc"
    )
    topology_path = os.path.join(
        base_dir, "data/001-rogfp-md/simulations/02-prep/mol.prmtop"
    )

    data_dir = os.path.join(base_dir, "analysis/001-rogfp-md/data/sdf")
    ...
    for element_type in element_types:
        ...
        if element_type == "O":
            atoms_1_str += "or (resname WAT and (around 6.0 (resname CRO and name OH)) and (around 6.5 (resid 143 and name OH)) and (around 6.0 (resid 201 and name CA)))"
