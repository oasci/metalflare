...
def main():
    ...
    atoms1_str = "resname CRO and name CG2"
    atoms2_str = "resid 62 and name HG1"
    ...
    atoms_npy_path = os.path.join(data_dir, "cro65_cg2-thr62_hg1-dist.npy")
    ...
    print(f"Min:  {np.min(atoms_dist_array)}")
    print(f"Mean: {np.mean(atoms_dist_array)}")
