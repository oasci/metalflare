...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/005-rogfp-glh-md/data/struct-desc/thr201_hg1-glu220_oe1-dist.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/thr201_hg1-glu220_oe1-dist.npy",
    )
    ...
    rogfp_cu_data_path = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/thr201_hg1-glu220_oe1-dist.npy",
    )
    rogfp_cu_data = np.load(rogfp_cu_data_path)

    rogfp_na_dist_path = os.path.join(
        base_dir,
        "analysis/008-rogfp-na-glh-md/data/struct-desc/thr201_hg1-glu220_oe1-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "d006-thr203_hg1-glu222_oe1"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 1.5}
    x_label = "Thr203 HG1 - Glu222 OE1 Distance [Å]"
    plot_x_bounds = (1, 10)
    y_label = "Density"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu, pmf_rogfp_na = compute_pmfs(
        x_values, 6.64, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu, pdf_rogfp_na), T=300.0
    )
