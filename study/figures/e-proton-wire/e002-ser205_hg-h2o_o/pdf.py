...
if __name__ == "__main__":
    ...
    rogfp_na_dist_path = os.path.join(
        base_dir,
        "analysis/008-rogfp-na-glh-md/data/struct-desc/ser203_hg-h2o_o-dist.npy",
    )
    ...
    bw_method = 0.003  # Manually tuned.
    ...
    # Make pdf plot
    fig_title = "e002-ser205_hg-h2o_o"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 5.11, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
