...
if __name__ == "__main__":
    ...
    rogfp_data_path_1 = os.path.join(
        base_dir, "analysis/005-rogfp-glh-md/data/struct-desc/ser203_og-h2o_h1-dist.npy"
    )
    rogfp_data_path_2 = os.path.join(
        base_dir, "analysis/005-rogfp-glh-md/data/struct-desc/ser203_og-h2o_h2-dist.npy"
    )
    ...
    rogfp_oxd_data_path_1 = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/ser203_og-h2o_h1-dist.npy",
    )
    rogfp_oxd_data_path_2 = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/ser203_og-h2o_h2-dist.npy",
    )
    ...
    rogfp_cu_data_path_1 = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/ser203_og-h2o_h1-dist.npy",
    )
    rogfp_cu_data_path_2 = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/ser203_og-h2o_h2-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "e010-ser205_og-h2o_h"
