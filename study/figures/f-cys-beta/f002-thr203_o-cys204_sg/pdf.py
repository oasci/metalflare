...
if __name__ == "__main__":
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/thr201_o-cyx202_sg-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "f002-thr203_o-cys204_sg"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 3.56, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
