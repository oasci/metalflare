...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/001-rogfp-md/data/struct-desc/cym202_ca_c-ser203_n_ca-dihedral.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/003-rogfp-cu-md/data/struct-desc/cym202_ca_c-ser203_n_ca-dihedral.npy",
    )
    ...
    # Make pdf plot
    fig_title = "f003-cys204_ca_c-ser205_n_ca"
    ...
    pmf_rogfp, pmf_rogfp_cu = compute_pmfs(
        x_values, -177.84, (pdf_rogfp, pdf_rogfp_cu), T=300.0
    )
