...
if __name__ == "__main__":
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/thr201_o-cyx145_sg-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "f001-thr203_o-cys147_sg"
    pdf_plt_kwargs = {"alpha": 0.5, "linewidth": 1.0}
    x_label = "THR203 O - CYS147 SG Distance [Å]"
    plot_x_bounds = (2.5, 5.5)
    y_label = "Density"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 4.05, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
