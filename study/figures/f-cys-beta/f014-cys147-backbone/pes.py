...
fig_label = "f014-pes"
data_x_str = "asn144_c-cys145_n_ca_c-dihedral"
data_x_label = "Cys147 $\phi$ [deg.]"
data_y_str = "cys145_n_ca_c-his146_n-dihedral"
data_y_label = "Cys147 $\psi$ [deg.]"

bin_width_angle = 2
bin_width_dist = 0.1
bins = (np.arange(-360, 0 + 0.01, bin_width_angle), np.arange(-180, 180 + 0.01, bin_width_angle))
x_lims = (-200, 0)
x_ticks = np.arange(-180, 0 + 0.001, 60)
y_lims = (90, 180)
