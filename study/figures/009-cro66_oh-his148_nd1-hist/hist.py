...
if __name__ == "__main__":
    ...
    rogfp_dist_path = os.path.join(
        base_dir, "analysis/001-rogfp-md/data/cro65_oh-hid146_nd1-dist.npy"
    )
    rogfp_dist = np.load(rogfp_dist_path)
    rogfp_cu_dist_path = os.path.join(
        base_dir, "analysis/003-rogfp-cu-md/data/cro65_oh-hid146_nd1-dist.npy"
    )
    ...
    plt.xlabel("CRO66 OH - HIS148 ND1 Distance [Å]")
    plt.xlim(2.5, 7.5)
    plt.ylabel("Density")
