...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/001-rogfp-md/data/struct-desc/cro65_cg2_cb2_ca2_c2-dihedral.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/cro65_cg2_cb2_ca2_c2-dihedral.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/003-rogfp-cu-md/data/struct-desc/cro65_cg2_cb2_ca2_c2-dihedral.npy",
    )
    ...
    # Make pdf plot
    fig_title = "a004-cro66_cg2_cb2_ca2_c2"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 186.67, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
    ...
    plt.xticks(np.arange(60, 301, 60))
