...
if __name__ == "__main__":
    ...
    rogfp_data_path_1 = os.path.join(
        base_dir,
        "analysis/001-rogfp-md/data/struct-desc/thr201_hg1-glu220_oe1-dist.npy",
    )
    ...
    rogfp_cu_data_path_2 = os.path.join(
        base_dir,
        "analysis/003-rogfp-cu-md/data/struct-desc/thr201_hg1-glu220_oe2-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "022-thr203_hg1-glu222_oe"
    pdf_plt_kwargs = {"alpha": 0.5, "linewidth": 1.0}
    x_label = "THR203 HG1 - GLU222 OE Distance [Å]"
    plot_x_bounds = (1, 7)
    y_label = "Density"
    ...
    pmf_rogfp, pmf_rogfp_cu = compute_pmfs(
        pdf_rogfp, pdf_rogfp_cu, x_values, 1.73, T=300.0
    )
