...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/001-rogfp-md/data/struct-desc/ser203_og_cb_ca_n-dihedral.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/ser203_og_cb_ca_n-dihedral.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/003-rogfp-cu-md/data/struct-desc/ser203_og_cb_ca_n-dihedral.npy",
    )
    ...
    # Make pdf plot
    fig_title = "014-ser205_og_cb_ca_n"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 63.24, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
