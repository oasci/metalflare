...
if __name__ == "__main__":
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/cro65_oh-thr201_og1-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "b002-cro66_oh-thr203_og1"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 4.04, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
