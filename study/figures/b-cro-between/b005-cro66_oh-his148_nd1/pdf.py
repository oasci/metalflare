...
if __name__ == "__main__":
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/004-rogfp-oxd-md/data/struct-desc/cro65_oh-hid146_nd1-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "b005-cro66_oh-his148_nd1"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 2.5}
    x_label = "CRO66 OH - HIS148 ND1 Distance [Å]"
    plot_x_bounds = (2.5, 7.5)
    y_label = "Density"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 2.89, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
