...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/005-rogfp-glh-md/data/struct-desc/tyr143_c-asn144_n_ca_c-dihedral.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/tyr143_c-asn144_n_ca_c-dihedral.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/tyr143_c-asn144_n_ca_c-dihedral.npy",
    )
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, -116.91, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
