...
if __name__ == "__main__":
    ...
    rogfp_na_dist_path = os.path.join(
        base_dir,
        "analysis/008-rogfp-na-glh-md/data/struct-desc/cro65_oh-his146_hd1-dist.npy",
    )
    ...
    bw_method = 0.05  # Manually adjusted
    ...
    # Make pdf plot
    fig_title = "g006-cro66_oh-his148_hd1"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 1.5}
    x_label = "Cro66 OH - His148 HD1 Distance [Å]"
    plot_x_bounds = (1, 7.5)
    y_label = "Density"
    ...
    pmf_rogfp, pmf_rogfp_oxd, pmf_rogfp_cu = compute_pmfs(
        x_values, 3.97, (pdf_rogfp, pdf_rogfp_oxd, pdf_rogfp_cu), T=300.0
    )
