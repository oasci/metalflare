...
if __name__ == "__main__":
    ...
    rogfp_dist_path = os.path.join(
        base_dir,
        "analysis/005-rogfp-glh-md/data/struct-desc/cro65_o3-gln92_ne2-dist.npy",
    )
    rogfp_data = np.load(rogfp_dist_path)
    # Oxidized
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/cro65_o3-gln92_ne2-dist.npy",
    )
    rogfp_oxd_data = np.load(rogfp_oxd_data_path)
    rogfp_cu_dist_path = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/cro65_o3-gln92_ne2-dist.npy",
    )
    rogfp_cu_data = np.load(rogfp_cu_dist_path)

    rogfp_na_dist_path = os.path.join(
        base_dir,
        "analysis/008-rogfp-na-glh-md/data/struct-desc/cro65_o3-gln92_ne2-dist.npy",
    )
    ...
    # Make pdf plot
    fig_title = "g017-cro66_o3-gln94_ne2"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 1.5}
    x_label = "Cro66 O3 - Gln94 NE2 Distance [Å]"
    plot_x_bounds = (2, 7)
    y_label = "Density"
