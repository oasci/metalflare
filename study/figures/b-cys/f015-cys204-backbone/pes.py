...
fig_label = "f015-pes"
data_x_str = "thr201_c-cys202_n_ca_c-dihedral"
data_x_label = "Cys204 $\phi$ [deg.]"
data_y_str = "cys202_n_ca_c-ser203_n-dihedral"
data_y_label = "Cys204 $\psi$ [deg.]"

bin_width_angle = 2
bin_width_dist = 0.1
bins = (np.arange(-360, 0 + 0.01, bin_width_angle), np.arange(0, 360 + 0.01, bin_width_angle))

x_lims = (-210, -50)
x_ticks = np.arange(-210, -50 + 0.001, 60)
y_lims = (30, 190)
