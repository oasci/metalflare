...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/005-rogfp-glh-md/data/struct-desc/phe221_ca_c-val222_n_ca.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/phe221_ca_c-val222_n_ca.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/phe221_ca_c-val222_n_ca.npy",
    )
    ...
    # Make pdf plot
    fig_title = "k002-phe223_ca_c-val224_n_ca"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 2.5}
    x_label = "phe223_ca_c-val224_n_ca [deg.]"
