...
if __name__ == "__main__":
    ...
    rogfp_data_path = os.path.join(
        base_dir,
        "analysis/005-rogfp-glh-md/data/struct-desc/phe221_n_ca_c-val222_n.npy",
    )
    ...
    rogfp_oxd_data_path = os.path.join(
        base_dir,
        "analysis/007-rogfp-oxd-glh-md/data/struct-desc/phe221_n_ca_c-val222_n.npy",
    )
    ...
    rogfp2_cu_path = os.path.join(
        base_dir,
        "analysis/006-rogfp-cu-glh-md/data/struct-desc/phe221_n_ca_c-val222_n.npy",
    )
    ...
    # Make pdf plot
    fig_title = "k001-phe223_n_ca_c-val224_n"
    pdf_plt_kwargs = {"alpha": 1.0, "linewidth": 1.5}
    x_label = "Phe223 $\psi$ [deg.]"
