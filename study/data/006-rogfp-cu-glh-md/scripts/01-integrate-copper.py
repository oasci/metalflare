...
TOPO_PATH = "../../005-rogfp-glh-md/simulations/02-prep/mol.prmtop"
COORD_PATH = "../../005-rogfp-glh-md/simulations/02-prep/mol.inpcrd"
CU_XYZ_PATH = "../../002-cu(i)-positioning/calculations/02-dock-copper/xtbopt.xyz"
WRITE_PATH = "../structures/protein/1JC0-Cu.pdb"

if not os.path.exists("../structures/protein"):
    os.makedirs("../structures/protein")
